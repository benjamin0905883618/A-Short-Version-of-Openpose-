...
try:
    ...
    parser.add_argument("--image_path", default="../../../examples/media/assassins-creed-3-remastered-review-790x444.jpg", help="Process an image. Read all standard formats (jpg, png, bmp, etc.).")
    ...
    while 1:
        ...
        #cv2.imwrite("OpenPose 1.6.0 - Tutorial Python API" + str(counter)+".jpg", combined)
        key = cv2.waitKey(-1)
        if key == 27:
            break
        counter += 1
